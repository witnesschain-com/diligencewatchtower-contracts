...
contract AlertManagerTest is Test {
    ...
    function testRaiseAlertWatchtowerOperatorInactive() public {
        ...
        alertManager.raiseAlert(chainID, l2BlockNumber, originalOutputRoot, computedOutputRoot, message);
        vm.stopPrank();
    }
    ...
    function testSubmitProofPass() public {
        ...
        (
            ...
            bytes memory _originalOutputRoot,
            bytes memory _computedOutputRoot,
            bytes memory _proofOfDiligence,
            address _sender
        ) = alertManager.alertsByAddress(watchtowersList[0]);
    ...
    function testGetAlerts() public {
        ...
        vm.startPrank(watchtowersList[0]);
        alertManager.raiseAlert(chainID, l2BlockNumber, originalOutputRoot, computedOutputRoot, message0);
        vm.stopPrank();

        vm.startPrank(watchtowersList[1]);

        alertManager.raiseAlert(chainID, l2BlockNumber, originalOutputRoot, computedOutputRoot, message1);
